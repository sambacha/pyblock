...
for data in datasets:
    for measure in [0, 1, 2]:
        ...
        for tag in tags:
            ...
            for timepoint in ordered:
                tagValues.append(
                    data[timepoint][tag][measure] / max(1, volumes[timepoint]) * 99
                )
        ...
        plot.set_ylabel(
            "stake of " + measureNames[measure] + "-volume in percent", fontsize=16
        )
        ...
        fig.savefig(
            "tagged_timeseries/OnlyTagged/" + filenames[filenamecounter] + ".png",
